...
public class RecruiterChat {
    ...
    public Object[] sendMessage(
        ...
        try {
            ...
            recruiterService.sendMessage(dealId, message, user.getRecruiterId());
    ...
    /**
     * Show chat messages to recruiter
     * @param dealId      Deal id
     ...
     * @throws Exception in very rare circumstances: it should be runtime
     * or servlet Exception to be thrown     */
    @RequestMapping(value = "/recruiter-show-messages.json", method = RequestMethod.GET)
