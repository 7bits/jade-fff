...
/**
 * Send file to Employer, requested downloading
 */
@Controller
public class EmployerAttachment {
     ...
     */
    @RequestMapping(value = "/employer-download-attachment/{attachmentId}", method = RequestMethod.GET)
