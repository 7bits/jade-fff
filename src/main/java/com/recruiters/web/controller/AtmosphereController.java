...
public class AtmosphereController {
    ...
    @RequestMapping(value="/test-sockets", method = RequestMethod.GET)
    public ModelAndView getView() {
        return new ModelAndView("test-sockets");
    }

    @RequestMapping(value = "/test-sockets/chat", method = RequestMethod.GET)
    @ResponseBody
    public void onRequest(AtmosphereResource atmosphereResource, HttpSession session) throws IOException {
    ...
    @RequestMapping(value = "/test-sockets/chat", method = RequestMethod.POST)
    @ResponseBody
    public void onPost(AtmosphereResource atmosphereResource) throws IOException{
        ...
        // here author parsed json with his own view
