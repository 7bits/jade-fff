...
/**
 * Vacancy logic "AND" specification
 */
public class VacancyAndSpecification extends VacancySpecification {
    ...
    public VacancyAndSpecification(final ISpecification<Vacancy> specification1, final ISpecification<Vacancy> specification2) {
