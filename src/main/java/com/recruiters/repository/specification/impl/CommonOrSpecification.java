...
/**
 * Common "Or" specification
 */
public class CommonOrSpecification extends CommonSpecification {
    ...
    public CommonOrSpecification(final ISpecification specification1, final ISpecification specification2) {
